...
const realQuestions = {
    ...
    "ancient-japan": [
        { q: "約1万年前から1万年近く続いた、土器や石器を使っていた時代を何といいますか。", a: "縄文時代", e: "表面に縄目のような模様のある縄文土器が特徴です。" },
        { q: "縄文時代、人々が食べたものの残りかすなどを捨てた場所を何といいますか。", a: "貝塚", e: "当時の人々の生活を知る重要な手がかりになります。" },
        { q: "紀元前4世紀頃から始まり、稲作や金属器が伝わった時代を何といいますか。", a: "弥生時代", e: "大陸から稲作や青銅器、鉄器が伝わりました。" },
        { q: "3世紀頃、多くの小国を従えていたとされる女王は誰ですか。", a: "卑弥呼", e: "邪馬台国の女王として中国の『魏志倭人伝』に記述があります。" },
        { q: "3世紀後半から、巨大な古墳が作られるようになった時代を何といいますか。", a: "古墳時代", e: "大和地方を中心に前方後円墳などが作られました。" },
        { q: "推古天皇の摂政となり、十七条の憲法や冠位十二階を定めたのは誰ですか。", a: "聖徳太子", e: "法隆寺を建立するなど、仏教を重んじました。" },
        { q: "645年、中大兄皇子らが蘇我氏を倒して始めた政治改革を何といいますか。", a: "大化の改新", e: "公地公民の原則などが打ち出されました。" },
        { q: "710年に唐の長安をモデルにして奈良に作られた都を何といいますか。", a: "平城京", e: "奈良時代はこの都を中心に栄えました。" },
        { q: "794年に桓武天皇によって京都に作られた都を何といいますか。", a: "平安京", e: "その後、約1000年にわたって日本の中心となりました。" },
        { q: "平安時代、藤原氏が娘を天皇のきさきにして、政治の実権を握った政治を何といいますか。", a: "摂関政治", e: "藤原道長・頼通の親子が全盛期を築きました。" }
    ],
    "constitution": [
        { q: "日本国憲法の三大原理は、「基本的人権の尊重」「平和主義」ともう一つは何ですか。", a: "国権在民（主権在民）", e: "政治の決定権は国民にあるという考え方です。" },
        { q: "日本国憲法において、天皇は何とされていますか。", a: "日本国の象徴", e: "憲法第1条に定められており、国政に関する権能は持ちません。" },
        { q: "憲法第9条で放棄されているものは何ですか。", a: "戦争", e: "武力の行使や戦力の保持も認められていません。" },
        { q: "国民が持つ「健康で文化的な最低限度の生活を営む権利」を何といいますか。", a: "生存権", e: "憲法第25条に規定されています。" },
        { q: "国民の三大義務は、「教育を受けさせる義務」「勤労の義務」ともう一つは何ですか。", a: "納税の義務", e: "憲法に定められた国民が果たすべき義務です。" },
        { q: "国会、内閣、裁判所が互いに抑制し合う仕組みを何といいますか。", a: "三権分立", e: "権力の集中を防ぎ、国民の権利を守るための仕組みです。" }
    ],
    "plant-world": [
    ...
    for (let i = 0; i < count; i++) {
        ...
        switch(uId) {
            ...
            case 'linear-equations':
                ...
                e = `両辺を ${n1} で割ります。`;
                break;
            case 'proportional-inverse':
                q = `yがxに比例し、x=${n1}のときy=${n1*n2}です。比例定数を求めなさい。`;
                a = n2.toString();
            ...
            case 'simultaneous-equations':
                q = `連立方程式 { x + y = ${n1+n2}, x - y = ${n1-n2} } を解きなさい。`;
                a = `x = ${n1}, y = ${n2}`;
                e = "加減法または代入法を用いて、文字を一種類消去します。";
                break;
            case 'linear-functions':
                q = `一次関数 y = ${n1}x + ${n2} の傾きと切片を答えなさい。`;
                a = `傾き: ${n1}, 切片: ${n2}`;
            ...
            case 'quadratic-equations':
                q = `二次方程式 x² - ${(n1+n2)}x + ${n1*n2} = 0 を解きなさい。`;
                a = `x = ${n1}, ${n2}`;
